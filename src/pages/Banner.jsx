            ...
            <div className="hero min-h-screen rounded-sm " style={{ backgroundImage: 'url(https://i.ibb.co/YLrgyqr/banner.jpg)' }}>
                ...
                <div className=" ">
                    <div className="text-center">
                        ...
                        <div className="">
                            <div className="  w-2/3 md:w-1/2 m-auto flex  ">
                                <div className=" w-2/3 bg-white rounded-l-xl">
                                    <input type="text" placeholder="Type here" className="text-[14px] md:text-xl bg-white rounded-l-xl  outline-none px-3 py-2" />
                                </div>
                                <div className="border-l-2 w-1/3 rounded-r-xl bg-green-500">
                                    <span className="text-center rounded-r-xl  px-3 py-2 text-[14px] md:text-xl ml-4">Search</span>
                                </div>
                            </div>
                        </div>
                    </div>
